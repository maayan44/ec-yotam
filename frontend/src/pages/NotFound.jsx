...
const NotFound = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center py-32 text-center' dir="rtl">
      ...
      {/* 404 is decorative — actual heading is visually hidden for screen readers */}
      <p className='text-8xl font-bold text-[#F5F5F0]' aria-hidden="true">404</p>
      <h1 className='text-2xl font-medium text-[#1A1A1A] mt-4 mb-2' style={{ fontFamily: 'Heebo, sans-serif' }}>
        דף לא נמצא
      </h1>
