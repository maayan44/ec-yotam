  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t border-t-[#A3A5A1]'>
      ...
      <div className='min-w-60'>
        ...
        {/* Category Filter */}
        <div className={`border border-[#A3A5A1] pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
          <p className='mb-3 text-sm font-medium'>CATEGORIES</p>
          <div className='flex flex-col gap-2 text-sm font-light text-[#535551]'>
        ...
        <div className={`border border-[#A3A5A1] pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
